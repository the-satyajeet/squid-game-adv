  ...
  return (
    <section>
      ...
      <p className=" flex justify-center items-center w-[26px] h-[20px] border-2 border-[#252525] rounded-b-md">
        ...
        <p className="text-white font-mono">28</p>
      </p>
    </div>
    <div className="flex-col justify-start items-start gap-2 inline-flex">
        <div><span className="text-white text-base font-bold font-['Vinila Test']">Sunday,</span><span className="text-white text-base font-normal font-['Vinila Test']"> </span><span className="text-white text-base font-light font-['Vinila Test']">April 28</span></div>
